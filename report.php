...
<div class="MyCard report">
    <form action="export-DTR.php" method="GET">

        <div class="d-flex flex-column gap-2" >
            <p style="font-size: var(--font-tertiary-size);">STUDENT NO.</p>
            <input type="text" name="student_no" id="student_no_for_dtr" class="form-control" placeholder="2023XXXXXX" style="width: 100%;" require>
        </div>
        <div class="d-flex flex-column ">
            ...
            <div class="d-flex flex-column mb-1">
                <div class="flex-grow-1 mb-0">
                    ...
                    <input type="date" name="from" id="date_from" class="form-control" style="width: 100%;" min="2026-07-06" required>
                </div>
                <div class="flex-grow-1 mb-0">
                    <label style="font-size: var(--font-tertiary-size); color: #666;">To</label>
                    <input type="date" name="to" id="date_to" class="form-control" style="width: 100%;" min="2026-07-06" required>
                </div>
            </div>
        </div>
        <div>
            <p style="font-size: var(--font-tertiary-size); color: #989898;">Please make sure everything is correct.</p>
            <button type="submit" class="btn" id="export_csv_button" style="width: 100%; margin-top: 1rem; background-color: var(--primary-color); color: white;">Download CSV File</button>
        </div>
    </form>
</div>
